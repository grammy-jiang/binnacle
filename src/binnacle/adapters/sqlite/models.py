...
class GitOperationStageModel(Base):
    ...
    effect_role: Mapped[str] = mapped_column(String(16), nullable=False)
...
class GitCommitEvidenceModel(Base):
    ...
    expected_main_index_identity_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    expected_main_index_tree_oid_algorithm: Mapped[str] = mapped_column(String(8), nullable=False)
    expected_main_index_tree_oid_hex: Mapped[str] = mapped_column(String(64), nullable=False)
    expected_main_index_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    target_main_index_tree_oid_algorithm: Mapped[str] = mapped_column(String(8), nullable=False)
    target_main_index_tree_oid_hex: Mapped[str] = mapped_column(String(64), nullable=False)
    target_main_index_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    selected_worktree_snapshot_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    main_index_publication_state: Mapped[str] = mapped_column(String(16), nullable=False)
    main_index_publication_receipt_sha256: Mapped[str | None] = mapped_column(String(64))
...
class GitRemoteEvidenceModel(Base):
    ...
    expected_remote_state: Mapped[str] = mapped_column(String(16), nullable=False)
    expected_oid_algorithm: Mapped[str | None] = mapped_column(String(8))
    expected_oid_hex: Mapped[str | None] = mapped_column(String(64))
    ...
    transport_evidence_sha256: Mapped[str | None] = mapped_column(String(64))
